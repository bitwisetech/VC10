...
# VC10 needs about 180 seconds (at speed 250 kts) fo a 180° turn, much more than a theoretical standard-turn
var wpAircraftSpecificTurnFactor = 2.0;
# passed distance (kts) per second per kt (VC10 needs 4 second to get into 20 deg. roll)
